...
Function Start-Debloat {
    ...
    [regex]$WhitelistedApps = 'Microsoft.WindowsCalculator|Microsoft.WindowsStore|Microsoft.Windows.Photos|`
    Microsoft.MicrosoftStickyNotes|.NET|Framework|Microsoft.HEIFImageExtension|Microsoft.StorePurchaseApp|`
